...
void BpSpec::initBreakPoints(const ResSeqPtr &res_seq_ptr) {
  ...
  double prm = 0;
  //int temp = res_seq_ptr->getLen();
  //std::cout << "case i = 0: " << res_seq_ptr->getResiduePtr(0)->getMass() << " & " << res_seq_ptr->getResMassSum() - res_seq_ptr->getResiduePtr(0)->getMass() << std::endl;
  //std::cout << "case i = len - 2: " << res_seq_ptr->getResiduePtr(temp-2)->getMass() << " & " << res_seq_ptr->getResMassSum() - res_seq_ptr->getResiduePtr(temp-2)->getMass() << std::endl;
  //std::cout << "case i = len - 1: " << res_seq_ptr->getResiduePtr(temp-1)->getMass() << " & " << res_seq_ptr->getResMassSum() - res_seq_ptr->getResiduePtr(temp-1)->getMass() << std::endl;
