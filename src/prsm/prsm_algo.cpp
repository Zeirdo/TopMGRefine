...
int getLastResPos(double c_term_shift, const std::vector<double> &prm_masses) {
  ...
  //std::cout << "residue_mass_sum: " << residue_mass_sum << std::endl;
  //std::cout << "trunc_mass: " << trunc_mass << std::endl;
  for (size_t i = 0; i < prm_masses.size(); i++) {
  ...
  //std::cout << "prm_masses[best_pos]" << prm_masses[best_shift] << std::endl;
  //std::cout << "best_shift: " << best_shift << std::endl;
  if (best_pos < 0) {
