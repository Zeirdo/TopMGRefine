...
int TopMG_identify(std::map<std::string, std::string> & arguments) {
  try {
    ...
    bool diagonal = (arguments["diagonal"] == "true");
    bool all_protein = (arguments["allProtein"] == "true");
    bool all_spectrum = (arguments["allSpectrum"] == "true");
    std::string specific_protein_name = arguments["proteinName"];
    int specific_spectrum_id = std::stoi(arguments["specID"]);
    short int protein_start_position = std::stoi(arguments["proStartPos"]);
    short int spectrum_start_position = std::stoi(arguments["specStartPos"]);
    ...
    GraphAlignMngPtr ga_mng_ptr
        = std::make_shared<GraphAlignMng>(prsm_para_ptr,
                                          ...
                                          thread_num, whole_protein_only, diagonal,
                                          all_protein,all_spectrum,
                                          specific_protein_name,specific_spectrum_id,
                                          protein_start_position,spectrum_start_position,
