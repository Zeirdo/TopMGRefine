...
inline TheoPeakPtrVec getDiagonalTheoPeak(ProteoformPtr proteo_ptr,
  ...
  std::cout << "first_res_pos: " << first_res_pos << "; last_res_pos: " << last_res_pos << std::endl;
  std::cout << "getMatchFirstBpPos: " << header_ptrs[i]->getMatchFirstBpPos() << "; getMatchLastBpPos: " << header_ptrs[i]->getMatchLastBpPos() << std::endl;
...
double refinePrecursorAndHeaderShift(ProteoformPtr proteo_ptr,
  ...
  std::cout << "tole in refinePrecusorAndHeaderShift is: " << tole << std::endl;
  ...
  //std::cout << "best_delta in refinePrecursorAndHeaderShift is: " << best_delta << std::endl;
