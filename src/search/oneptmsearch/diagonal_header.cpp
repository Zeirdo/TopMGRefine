...
void DiagonalHeader::initHeader(double c_shift, ProteoformPtr proteo_ptr,
  ...
  //trunc_last_res_pos_ = prsm_algo::getFirstResPos(prot_C_term_shift_, prm_masses);
  ...
  //std::cout << "trunc_first_res_pos_: " << trunc_first_res_pos_ << "; trunc_last_res_pos_: " << trunc_last_res_pos_ << std::endl;
  //std::cout << "match_first_bp_pos_: " << getMatchFirstBpPos() << "; match_last_bp_pos_: " << getMatchLastBpPos() << std::endl;
  //std::cout << "prot_N_term_shift_: " << prot_N_term_shift_ << "; prot_C_term_shift_: " << prot_C_term_shift_ << std::endl;
  //std::cout << "pep_N_term_shift_: " << pep_N_term_shift_ << "; pep_C_term_shift_: " << pep_C_term_shift_ << std::endl;
  //std::cout << "align_pref_suff_shift_thresh: " << align_pref_suff_shift_thresh << "; is_align_prefix_: " << is_align_prefix_ << "; is_align_suffix_: " << is_align_suffix_ << std::endl;
}
