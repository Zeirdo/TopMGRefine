...
typedef std::pair<std::pair<short int,short int>,std::tuple<short int, int, short int>> prePosition;
...
class GraphAlign {
 ...
 private:
  ...
  void addToNewConsistentPairs(int m, const std::vector<std::pair<int, int>> & sp_pair_ij,
