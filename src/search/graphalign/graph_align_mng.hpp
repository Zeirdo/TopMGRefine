...
class GraphAlignMng {
 public:
  GraphAlignMng(PrsmParaPtr prsm_para_ptr,
                ...
                bool all_protein,
                bool all_spectrum,
                std::string specific_protein_name,
                int specific_spectrum_id,
                short int protein_start_position,
                short int spectrum_start_position,
      ...
      diagonal_(diagonal),
      all_protein_(all_protein),
      all_spectrum_(all_spectrum),
      specific_protein_name_(specific_protein_name),
      specific_spectrum_id_(specific_spectrum_id),
      protein_start_position_(protein_start_position),
      spectrum_start_position_(spectrum_start_position),
  ...
  bool all_protein_ = false;

  bool all_spectrum_ = false;

  std::string specific_protein_name_ = "sp|P76347|YEEJ_ECOLI";

  int specific_spectrum_id_ = 2668;

  short int protein_start_position_ = 1086; //From 0 to protein size - 1.

  short int spectrum_start_position_ = 0; //From 0 to spectrum size - 1.
